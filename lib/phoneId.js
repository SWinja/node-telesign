...
(function() {
  ...
  PhoneID.scoreNew = function(options, callback) {
    if (!options || typeof options !== 'object') {
      throw new Error('Error calling PhoneID Score - no params object provided.');
    } else if (!callback || typeof callback !== 'function') {
      throw new Error('Error calling PhoneID Score - no callback function provided.');
      ...
      return callback('Error calling PhoneID Score - "phoneNumber" not provided in the request params.');
    } else if (!options.accountLifecycleEvent) {
      return callback('Error calling PhoneID Score - "accountLifecycleEvent" not provided in the request params.');
    }

    sendRequest.request({
      method: 'POST',
      resource: '/score/' + options.phoneNumber,
      fields: {
        account_lifecycle_event: options.accountLifecycleEvent
      }
    }, function(err, data) {
      return callback(err, data);
    });
  ...
  PhoneID.contactPlus = function(options, callback) {
    if (!options || typeof options !== 'object') {
      throw new Error('Error calling PhoneID Contact - no params object provided.');
    } else if (!callback || typeof callback !== 'function') {
      throw new Error('Error calling PhoneID Contact - no callback function provided.');
    ...
    sendRequest.request({
      method: 'POST',
      resource: '/phoneid/' + options.phoneNumber,
      fields: "json",
      fieldsJson: fields
    }, function(err, data) {
      return callback(err, data);
